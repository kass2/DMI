  ...
  return (
    <NavigationContainer independent={true}>
      ...
      >
        ...
        <Tab.Screen name={i18n.t("menu-Favourites")}>{(props) => <Favoritos{...props} items={photoURL} photo={setPhoto} email={email}/>}</Tab.Screen>
        <Tab.Screen name={i18n.t("menu-Record")}>{(props) => <Historial{...props} items={photoURL} photo={setPhoto} email={email}/>}</Tab.Screen>
      </Tab.Navigator>
    </NavigationContainer>
  );
};
